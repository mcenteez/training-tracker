                  ...
                  await databaseTransaction
                    ...
                    .values(
                      sourceItems.map((sourceItem) => ({
                        ...
                        resistanceType: sourceItem.resistanceType,
                        resistanceValue: sourceItem.resistanceValue,
                        resistanceUnit: sourceItem.resistanceUnit,
                        resistancePercentage: sourceItem.resistancePercentage,
                        resistanceTarget: sourceItem.resistanceTarget,
                        resistanceDescription: sourceItem.resistanceDescription,
                        normalizedResistanceKg:
                          sourceItem.normalizedResistanceKg,
